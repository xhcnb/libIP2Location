...
int32_t IP2Location_DB_set_static_buffer(void *buffer)
{
	DB_access_type = IP2LOCATION_STATIC_BUFFER;
	cache_shm_ptr = buffer;
	return 0;
}
...
int32_t IP2Location_DB_close(FILE *filehandle)
{
    ...
    else if ( DB_access_type == IP2LOCATION_STATIC_BUFFER) {
        cache_shm_ptr = NULL;
    }
	DB_access_type = IP2LOCATION_FILE_IO;
	return 0;
